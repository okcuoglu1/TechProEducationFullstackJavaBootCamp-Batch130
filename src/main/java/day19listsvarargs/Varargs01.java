...
public class Varargs01 {
    ...
    /*
        ...
        Note 1: Bir method'da 1 den fazla Varargs Parametre kullanilamaz cunku ikincisi "Unreachable Code"(Ulaşılamaz kod) olur.
    ...
    public static void main(String[] args) {
        ...
        addThreeNumbers(3,7,2);

        add(4,5,6,7,8,9,0,1,1,1);

    }


    //İki sayiyi toplayan method olusturunuz.
    ...
    //İstedigimiz sayıda sayıyı toplamak icin bir method olusturunuz.
