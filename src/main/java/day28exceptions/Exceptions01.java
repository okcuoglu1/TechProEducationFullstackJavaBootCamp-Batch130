...
public class Exceptions01 {
    ...
    /*
        ...
        7) İçinde rakamlar dışında character olan bir String 'i sayıya çevirmek isterseniz Java "NumberFormatException" atar
        8) Bütün exceptionlar classtır
       9)String'lerde var olmayan index'ler kullanıldığında Java "StringIndexOutOfBoundsException" atar.
       10) Array'lerde olmayan index kullanıldığında ArrayIndexOutOfBounds atar.
     */
