...
//Interface lerde tum methodlar publictir, static değildir,abstractir
//Interface'ler "concrete" method icermezler, dolayisiyla interface'in icindeki hicbirsey istege bagli degildir
// Interfacein icindeki hersey child class'lar icin mecburidir, bu yuzden Interface'lere "to-do list" denir.
}
